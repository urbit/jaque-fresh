...
public final class FastRootNode extends RootNode {
  ...
  // FastRootNode takes an optional clue name.
  public FastRootNode(NockLanguage language,
    ...
    // TODO: This must be taken in since we don't have the clue here?
    this.hintName       = null;
  }
  ...
  public Object execute(VirtualFrame frame) {
    ...
    if (tracer != null && hintName != null) {
      tracer.push(hintName);
    }

    Object ret = bodyNode.executeGeneric(frame);
