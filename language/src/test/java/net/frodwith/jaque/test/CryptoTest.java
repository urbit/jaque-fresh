...
public class CryptoTest {
  ...
  public void testAesEcba() throws ExitException {
    ...
    assertNounEquals(out, AtomCrypto.aes_ecb(Cipher.ENCRYPT_MODE, 16, key, in));
    assertNounEquals(in, AtomCrypto.aes_ecb(Cipher.DECRYPT_MODE, 16, key, out));
  }
  ...
  public void testAesCbca() throws ExitException {
    ...
    assertNounEquals(out, AtomCrypto.aes_cbc(Cipher.ENCRYPT_MODE, 16, key, iv, in));
    assertNounEquals(in, AtomCrypto.aes_cbc(Cipher.DECRYPT_MODE, 16, key, iv, out));
  }
}
